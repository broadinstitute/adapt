...
These details include required positional arguments for some choices of subcommands.
...
* `count`: Number of guide sequences for this window.
...
* `target-sequences`: Sequences of the targets for this window from which to construct guides, separated by spaces (see [Complementarity](#complementarity)).
